...
export interface FeishuMessage {
  ...
  at?: string | string[];
  /** 加急：发送蓝色主题交互式卡片并 @所有人，强制手机端弹窗通知（飞书自定义机器人不支持加急消息类型） */
  urgent?: boolean;
}
...
export async function sendFeishu(
  ...
  if (options.urgent) {
    ...
    body.card = {
      ...
      header: {
        title: { tag: 'plain_text', content: '🎫 12306 购票提醒' },
        template: 'blue',
      },
...
export { notifyOrderSuccess, notifyDuplicatedOrder, notifySessionInvalid, notifyTaskFailed } from './service.js';
